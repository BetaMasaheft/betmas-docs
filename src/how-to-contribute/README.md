...
Whether you are interacting with others by creating and reacting to issues, by making and reviewing `Pull Requests` or in other ways, please take a few instants to read the following remarks to make all interactions as agreeable and as efficient as possible. 
...
* Only the team members can commit to the master branch, but are discouraged to do so.

* Only the tech lead can commit to the master branch.
...
* Everyone can open issues, comment and contribute to the conversations.


## Creating good issues

Always make sure that you are familiar with the [Code of conduct](../code-of-conduct/README.md).

Please use one of the templates. Try to be as clear as possible and detail the problem you are seeing in a way facilitating the work of those who can help to solve it. 


## Branches, commits, pull requests

For any task that you are carring out, big or small, create a new branch from the latest master status. Fetch the origin, pull all updates, and then make your new branch. Any GitHub tutorial, and they abound, is fine here.
...
The code of conduct can be found at [Code of conduct](../code-of-conduct/README.md).
...
improvement, you try to fix it yourself first, if possible.
